            ...
            <div class="form-block mx-auto">
              ...
              <form action="/signup" method="post">
                ...
                <div class="form-group first">
                  ...
                  <input type="text" name="name" class="form-control" placeholder="your-email@gmail.com" id="username">
                </div>
                <div class="form-group first">
                ...
                <div class="form-group last mb-1">
                  ...
                  <input type="password" name="c_password" class="form-control" placeholder="Your Password" id="password">
                </div>
                
                <div class="d-sm-flex mb-5 align-items-center">
                  <label class="control control--checkbox mb-1 mb-sm-0"><span class="caption">Remember me</span>
                ...
                <span class="text-center my-3 d-block">You have account : </span>

                <a href="/" class="btn btn-block py-2 btn-secondary" style="color: white">Login</a>
              </form>
            </div>
          </div>
        </div>  
